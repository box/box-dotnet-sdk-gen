...
namespace Box.Schemas {
    public class FolderSharedLinkField {
        ...
        public FolderSharedLinkField(string url, FolderSharedLinkFieldEffectiveAccessField effectiveAccess, FolderSharedLinkFieldEffectivePermissionField effectivePermission, bool isPasswordEnabled, int downloadCount, int previewCount) {
            Url = url;
