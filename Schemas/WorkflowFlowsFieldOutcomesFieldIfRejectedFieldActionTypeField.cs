...
namespace Box.Schemas {
    [JsonConverter(typeof(StringEnumConverter<WorkflowFlowsFieldOutcomesFieldIfRejectedFieldActionTypeField>))]
    public enum WorkflowFlowsFieldOutcomesFieldIfRejectedFieldActionTypeField {
