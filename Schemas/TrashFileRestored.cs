...
namespace Box.Schemas {
    public class TrashFileRestored {
        ...
        public TrashFileRestored(string id, string etag, TrashFileRestoredTypeField type, string sequenceId, string name, string sha1, FileVersionMini fileVersion, string description, int size, TrashFileRestoredPathCollectionField pathCollection, string createdAt, string modifiedAt, string trashedAt, string purgedAt, string contentCreatedAt, string contentModifiedAt, UserMini createdBy, UserMini modifiedBy, UserMini ownedBy, string sharedLink, FolderMini parent, TrashFileRestoredItemStatusField itemStatus) {
            Id = id;
            Etag = etag;
            Type = type;
