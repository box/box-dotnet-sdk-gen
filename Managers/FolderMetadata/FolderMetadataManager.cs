...
namespace Box.Managers {
    public class FolderMetadataManager {
        ...
        public async System.Threading.Tasks.Task<Metadata> UpdateFolderMetadataById(string folderId, UpdateFolderMetadataByIdScopeArg scope, string templateKey, UpdateFolderMetadataByIdRequestBodyArg requestBody, UpdateFolderMetadataByIdHeadersArg headers) {
            Dictionary<string, string> headersMap = Utils.PrepareParams(DictionaryUtils.MergeDictionaries(new Dictionary<string, string>() {  }, headers.ExtraHeaders));
