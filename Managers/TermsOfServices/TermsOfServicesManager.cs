...
namespace Box.Managers {
    public class TermsOfServicesManager {
        ...
        public TermsOfServicesManager(IAuth auth, NetworkSession networkSession) {
            Auth = auth;
            NetworkSession = networkSession;
        }
        public async System.Threading.Tasks.Task<TermsOfServices> GetTermOfServices(GetTermOfServicesQueryParamsArg queryParams, GetTermOfServicesHeadersArg headers) {
        ...
        public async System.Threading.Tasks.Task<Task> CreateTermOfService(CreateTermOfServiceRequestBodyArg requestBody, CreateTermOfServiceHeadersArg headers) {
            Dictionary<string, string> headersMap = Utils.PrepareParams(DictionaryUtils.MergeDictionaries(new Dictionary<string, string>() {  }, headers.ExtraHeaders));
        ...
        public async System.Threading.Tasks.Task<TermsOfService> GetTermOfServiceById(string termsOfServiceId, GetTermOfServiceByIdHeadersArg headers) {
            Dictionary<string, string> headersMap = Utils.PrepareParams(DictionaryUtils.MergeDictionaries(new Dictionary<string, string>() {  }, headers.ExtraHeaders));
        ...
        public async System.Threading.Tasks.Task<TermsOfService> UpdateTermOfServiceById(string termsOfServiceId, UpdateTermOfServiceByIdRequestBodyArg requestBody, UpdateTermOfServiceByIdHeadersArg headers) {
            Dictionary<string, string> headersMap = Utils.PrepareParams(DictionaryUtils.MergeDictionaries(new Dictionary<string, string>() {  }, headers.ExtraHeaders));
