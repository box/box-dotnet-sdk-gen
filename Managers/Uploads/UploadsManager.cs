...
namespace Box.Managers {
    public class UploadsManager {
        ...
        public UploadsManager(IAuth auth, NetworkSession networkSession) {
            Auth = auth;
            NetworkSession = networkSession;
        }
        public async System.Threading.Tasks.Task<Files> UploadFileVersion(string fileId, UploadFileVersionRequestBodyArg requestBody, UploadFileVersionQueryParamsArg queryParams, UploadFileVersionHeadersArg headers) {
        ...
        public async System.Threading.Tasks.Task<Files> UploadFile(UploadFileRequestBodyArg requestBody, UploadFileQueryParamsArg queryParams, UploadFileHeadersArg headers) {
            Dictionary<string, string> queryParamsMap = Utils.PrepareParams(new Dictionary<string, string>() { { "fields", Utils.ToString(queryParams.Fields) } });
        ...
        public async System.Threading.Tasks.Task<UploadUrl> PreflightFileUpload(PreflightFileUploadRequestBodyArg requestBody, PreflightFileUploadHeadersArg headers) {
