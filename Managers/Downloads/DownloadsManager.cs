...
namespace Box.Managers {
    public class DownloadsManager {
        ...
        public async System.Threading.Tasks.Task<Stream> DownloadFile(string fileId, DownloadFileQueryParamsArg? queryParams = default, DownloadFileHeadersArg? headers = default) {
