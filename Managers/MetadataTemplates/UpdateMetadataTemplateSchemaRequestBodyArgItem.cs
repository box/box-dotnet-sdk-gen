...
namespace Box.Managers {
    public class UpdateMetadataTemplateSchemaRequestBodyArgItem {
        [JsonPropertyName("op")]
        public UpdateMetadataTemplateSchemaRequestBodyArgItemOpField Op { get; }
