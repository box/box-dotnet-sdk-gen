...
namespace Box.Managers {
    public class UpdateFolderAddSharedLinkRequestBodyArgSharedLinkField {
        ...
        public UpdateFolderAddSharedLinkRequestBodyArgSharedLinkFieldAccessField? Access { get; set; } = default;
        ...
        public UpdateFolderAddSharedLinkRequestBodyArgSharedLinkFieldPermissionsField? Permissions { get; set; } = default;

        public UpdateFolderAddSharedLinkRequestBodyArgSharedLinkField() {
