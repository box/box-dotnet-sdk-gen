...
namespace Box.Managers {
    public class AuthorizationManager {
        ...
        public AuthorizationManager(IAuth auth, NetworkSession networkSession) {
            Auth = auth;
            NetworkSession = networkSession;
        }
        public async System.Threading.Tasks.Task GetAuthorize(GetAuthorizeQueryParamsArg queryParams, GetAuthorizeHeadersArg headers) {
