...
namespace Box.Managers {
    public class FilesManager {
        ...
        public async System.Threading.Tasks.Task<Stream> GetFileThumbnailById(string fileId, GetFileThumbnailByIdExtensionArg extension, GetFileThumbnailByIdQueryParamsArg? queryParams = default, GetFileThumbnailByIdHeadersArg? headers = default) {
