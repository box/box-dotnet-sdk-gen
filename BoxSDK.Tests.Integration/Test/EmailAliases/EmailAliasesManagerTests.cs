...
namespace Box.Tests.Integration {
    ...
    public class EmailAliasesManagerTests {
        ...
        public async System.Threading.Tasks.Task TestEmailAliases() {
            ...
            UserFull newUser = await client.Users.CreateUserAsync(requestBody: new CreateUserRequestBodyArg(name: newUserName) { Login = newUserLogin }).ConfigureAwait(false);
            ...
            EmailAlias newAlias = await client.EmailAliases.CreateUserEmailAliasAsync(userId: newUser.Id, requestBody: new CreateUserEmailAliasRequestBodyArg(email: newAliasEmail)).ConfigureAwait(false);
