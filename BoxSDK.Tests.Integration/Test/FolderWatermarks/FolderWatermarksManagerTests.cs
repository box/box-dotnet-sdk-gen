...
namespace Box.Tests.Integration {
    ...
    public class FolderWatermarksManagerTests {
        ...
        public async System.Threading.Tasks.Task TestCreateGetDeleteFolderWatermark() {
            ...
            FolderFull folder = await client.Folders.CreateFolderAsync(requestBody: new CreateFolderRequestBodyArg(name: folderName, parent: new CreateFolderRequestBodyArgParentField(id: "0"))).ConfigureAwait(false);
            Watermark createdWatermark = await client.FolderWatermarks.UpdateFolderWatermarkAsync(folderId: folder.Id, requestBody: new UpdateFolderWatermarkRequestBodyArg(watermark: new UpdateFolderWatermarkRequestBodyArgWatermarkField(imprint: UpdateFolderWatermarkRequestBodyArgWatermarkFieldImprintField.Default))).ConfigureAwait(false);
