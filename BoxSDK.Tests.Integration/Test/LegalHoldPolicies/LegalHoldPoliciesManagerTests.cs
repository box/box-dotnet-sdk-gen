...
namespace Box.Tests.Integration {
    ...
    public class LegalHoldPoliciesManagerTests {
        ...
        public async System.Threading.Tasks.Task TestCreateUpdateGetDeleteLegalHoldPolicy() {
            ...
            LegalHoldPolicy legalHoldPolicy = await client.LegalHoldPolicies.CreateLegalHoldPolicyAsync(new CreateLegalHoldPolicyRequestBodyArg(policyName: legalHoldPolicyName) { Description = legalHoldDescription, IsOngoing = true }).ConfigureAwait(false);
            ...
            LegalHoldPolicy legalHoldPolicyById = await client.LegalHoldPolicies.GetLegalHoldPolicyByIdAsync(legalHoldPolicyId).ConfigureAwait(false);
            ...
            LegalHoldPolicy updatedLegalHoldPolicy = await client.LegalHoldPolicies.UpdateLegalHoldPolicyByIdAsync(legalHoldPolicyId, new UpdateLegalHoldPolicyByIdRequestBodyArg() { PolicyName = updatedLegalHoldPolicyName }).ConfigureAwait(false);
