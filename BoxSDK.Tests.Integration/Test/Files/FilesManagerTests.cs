...
namespace Box.Tests.Integration {
    ...
    public class FilesManagerTests {
        ...
        public async System.Threading.Tasks.Task TestGetFileFullExtraFields() {
            ...
            FileFull file = await client.Files.GetFileById(uploadedFile.Id, new GetFileByIdQueryParamsArg() { Fields = "is_externally_owned,has_collaborations" });
        ...
        public async System.Threading.Tasks.Task TestCreateGetAndDeleteFile() {
            ...
            await Assert.ThrowsExceptionAsync<Exception>(async() => await client.Files.GetFileById(uploadedFile.Id, new GetFileByIdQueryParamsArg() { Fields = "name" }, new GetFileByIdHeadersArg() { ExtraHeaders = new Dictionary<string, string>() { { "if-none-match", file.Etag } } }));
