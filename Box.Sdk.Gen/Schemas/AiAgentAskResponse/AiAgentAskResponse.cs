...
namespace Box.Sdk.Gen.Schemas {
    public class AiAgentAskResponse {
        /// <summary>
        /// The type of AI agent used to handle queries.
        /// </summary>
        [JsonPropertyName("type")]
        [JsonConverter(typeof(StringEnumConverter<AiAgentAskResponseTypeField>))]
        public StringEnum<AiAgentAskResponseTypeField>? Type { get; init; }
