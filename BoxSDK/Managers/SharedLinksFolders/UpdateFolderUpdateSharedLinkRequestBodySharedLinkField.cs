...
namespace Box.Managers {
    public class UpdateFolderUpdateSharedLinkRequestBodySharedLinkField {
        /// <summary>
        ...
        public UpdateFolderUpdateSharedLinkRequestBodySharedLinkAccessField? Access { get; set; } = default;
        ...
        public UpdateFolderUpdateSharedLinkRequestBodySharedLinkPermissionsField? Permissions { get; set; } = default;

        public UpdateFolderUpdateSharedLinkRequestBodySharedLinkField() {
