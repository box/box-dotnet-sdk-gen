...
namespace Box.Managers {
    public class UpdateFolderUpdateSharedLinkRequestBodySharedLinkPermissionsField {
        /// <summary>
        ...
        public UpdateFolderUpdateSharedLinkRequestBodySharedLinkPermissionsField() {
