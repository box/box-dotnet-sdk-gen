...
namespace Box.Managers {
    public class UpdateFolderAddSharedLinkRequestBodySharedLinkField {
        /// <summary>
        ...
        public UpdateFolderAddSharedLinkRequestBodySharedLinkAccessField? Access { get; set; } = default;
        ...
        public UpdateFolderAddSharedLinkRequestBodySharedLinkPermissionsField? Permissions { get; set; } = default;

        public UpdateFolderAddSharedLinkRequestBodySharedLinkField() {
