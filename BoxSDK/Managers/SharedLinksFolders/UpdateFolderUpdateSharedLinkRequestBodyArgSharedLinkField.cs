...
namespace Box.Managers {
    public class UpdateFolderUpdateSharedLinkRequestBodyArgSharedLinkField {
        ...
        public UpdateFolderUpdateSharedLinkRequestBodyArgSharedLinkFieldAccessField? Access { get; set; } = default;
        ...
        public UpdateFolderUpdateSharedLinkRequestBodyArgSharedLinkFieldPermissionsField? Permissions { get; set; } = default;

        public UpdateFolderUpdateSharedLinkRequestBodyArgSharedLinkField() {
