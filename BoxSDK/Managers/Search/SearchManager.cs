...
namespace Box.Managers {
    public class SearchManager : ISearchManager {
        ...
        /// </param>
        public async System.Threading.Tasks.Task<MetadataQueryResults> CreateMetadataQueryExecuteReadAsync(MetadataQuery requestBody, CreateMetadataQueryExecuteReadHeaders? headers = default, System.Threading.CancellationToken? cancellationToken = null) {
            headers = headers ?? new CreateMetadataQueryExecuteReadHeaders();
        ...
        /// Token used for request cancellation.
        /// </param>
        public async System.Threading.Tasks.Task<SearchResultsOrSearchResultsWithSharedLinks> GetSearchAsync(GetSearchQueryParams? queryParams = default, GetSearchHeaders? headers = default, System.Threading.CancellationToken? cancellationToken = null) {
            queryParams = queryParams ?? new GetSearchQueryParams();
            headers = headers ?? new GetSearchHeaders();
