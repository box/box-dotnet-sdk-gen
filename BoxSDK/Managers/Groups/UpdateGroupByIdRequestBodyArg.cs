...
namespace Box.Managers {
    public class UpdateGroupByIdRequestBodyArg {
        ...
        public UpdateGroupByIdRequestBodyArgInvitabilityLevelField? InvitabilityLevel { get; set; } = default;
        ...
        public UpdateGroupByIdRequestBodyArgMemberViewabilityLevelField? MemberViewabilityLevel { get; set; } = default;

        public UpdateGroupByIdRequestBodyArg() {
