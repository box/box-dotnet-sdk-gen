...
namespace Box.Managers {
    public class UpdateTaskByIdRequestBodyArg {
        ...
        public UpdateTaskByIdRequestBodyArgActionField? Action { get; set; } = default;
        ...
        public UpdateTaskByIdRequestBodyArgCompletionRuleField? CompletionRule { get; set; } = default;

        public UpdateTaskByIdRequestBodyArg() {
