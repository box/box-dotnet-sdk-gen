...
namespace Box.Managers {
    public class UpdateFileByIdRequestBodyArgSharedLinkField {
        ...
        public UpdateFileByIdRequestBodyArgSharedLinkFieldAccessField? Access { get; set; } = default;
        ...
        public UpdateFileByIdRequestBodyArgSharedLinkFieldPermissionsField? Permissions { get; set; } = default;

        public UpdateFileByIdRequestBodyArgSharedLinkField() {
