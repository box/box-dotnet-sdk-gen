...
namespace Box.Managers {
    public class UpdateFileByIdRequestBodyArg {
        ...
        public UpdateFileByIdRequestBodyArgParentField? Parent { get; set; } = default;

        [JsonPropertyName("shared_link")]
        public UpdateFileByIdRequestBodyArgSharedLinkField? SharedLink { get; set; } = default;
        ...
        public UpdateFileByIdRequestBodyArgLockField? Lock { get; set; } = default;
        ...
        public UpdateFileByIdRequestBodyArgPermissionsField? Permissions { get; set; } = default;
        ...
        public IReadOnlyList<UpdateFileByIdRequestBodyArgCollectionsField>? Collections { get; set; } = default;
