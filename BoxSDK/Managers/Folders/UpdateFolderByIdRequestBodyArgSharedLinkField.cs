...
namespace Box.Managers {
    public class UpdateFolderByIdRequestBodyArgSharedLinkField {
        ...
        public UpdateFolderByIdRequestBodyArgSharedLinkFieldAccessField? Access { get; set; } = default;
        ...
        public UpdateFolderByIdRequestBodyArgSharedLinkFieldPermissionsField? Permissions { get; set; } = default;

        public UpdateFolderByIdRequestBodyArgSharedLinkField() {
