...
namespace Box.Managers {
    public class UpdateFolderByIdRequestBodyArg {
        ...
        public UpdateFolderByIdRequestBodyArgSyncStateField? SyncState { get; set; } = default;
        ...
        public UpdateFolderByIdRequestBodyArgParentField? Parent { get; set; } = default;

        [JsonPropertyName("shared_link")]
        public UpdateFolderByIdRequestBodyArgSharedLinkField? SharedLink { get; set; } = default;

        [JsonPropertyName("folder_upload_email")]
        public UpdateFolderByIdRequestBodyArgFolderUploadEmailField? FolderUploadEmail { get; set; } = default;
        ...
        public IReadOnlyList<UpdateFolderByIdRequestBodyArgCollectionsField>? Collections { get; set; } = default;
        ...
        public UpdateFolderByIdRequestBodyArg() {
