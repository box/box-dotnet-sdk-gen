...
namespace Box.Managers {
    public class GetFolderByIdQueryParamsArg {
        ...
        ///   before web links.
        /// </summary>
        public GetFolderByIdQueryParamsArgSortField? Sort { get; set; } = default;

        /// <summary>
        /// The direction to sort results in. This can be either in alphabetical ascending
        /// (`ASC`) or descending (`DESC`) order.
        /// </summary>
        public GetFolderByIdQueryParamsArgDirectionField? Direction { get; set; } = default;
        ...
        public GetFolderByIdQueryParamsArg() {
