...
namespace Box.Managers {
    public class GetFolderItemsQueryParamsArg {
        ...
        ///   before web links.
        /// </summary>
        public GetFolderItemsQueryParamsArgSortField? Sort { get; set; } = default;

        /// <summary>
        /// The direction to sort results in. This can be either in alphabetical ascending
        /// (`ASC`) or descending (`DESC`) order.
        /// </summary>
        public GetFolderItemsQueryParamsArgDirectionField? Direction { get; set; } = default;

        public GetFolderItemsQueryParamsArg() {
