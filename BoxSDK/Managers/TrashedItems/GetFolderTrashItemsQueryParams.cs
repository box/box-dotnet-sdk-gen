...
namespace Box.Managers {
    public class GetFolderTrashItemsQueryParams {
        /// <summary>
        ...
        /// </summary>
        public GetFolderTrashItemsQueryParamsDirectionField? Direction { get; set; } = default;
        ...
        /// </summary>
        public GetFolderTrashItemsQueryParamsSortField? Sort { get; set; } = default;

        public GetFolderTrashItemsQueryParams() {
