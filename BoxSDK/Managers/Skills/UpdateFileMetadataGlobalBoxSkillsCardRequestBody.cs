...
namespace Box.Managers {
    public class UpdateFileMetadataGlobalBoxSkillsCardRequestBody {
        /// <summary>
        /// `replace`
        /// </summary>
        [JsonPropertyName("op")]
        public UpdateFileMetadataGlobalBoxSkillsCardRequestBodyOpField? Op { get; set; } = default;
        ...
        public UpdateFileMetadataGlobalBoxSkillsCardRequestBody() {
