...
namespace Box.Managers {
    public class InvitesManager {
        ...
        /// </param>
        public async System.Threading.Tasks.Task<Invite> CreateInviteAsync(CreateInviteRequestBodyArg requestBody, CreateInviteQueryParamsArg? queryParams = default, CreateInviteHeadersArg? headers = default) {
            ...
            return SimpleJsonSerializer.Deserialize<Invite>(response.Text);
        }
        ...
        /// </param>
        public async System.Threading.Tasks.Task<Invite> GetInviteByIdAsync(string inviteId, GetInviteByIdQueryParamsArg? queryParams = default, GetInviteByIdHeadersArg? headers = default) {
