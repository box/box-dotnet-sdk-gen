...
namespace Box.Managers {
    public class UpdateWebLinkUpdateSharedLinkRequestBodyArgSharedLinkField {
        ...
        public UpdateWebLinkUpdateSharedLinkRequestBodyArgSharedLinkFieldAccessField? Access { get; set; } = default;
        ...
        public UpdateWebLinkUpdateSharedLinkRequestBodyArgSharedLinkFieldPermissionsField? Permissions { get; set; } = default;

        public UpdateWebLinkUpdateSharedLinkRequestBodyArgSharedLinkField() {
