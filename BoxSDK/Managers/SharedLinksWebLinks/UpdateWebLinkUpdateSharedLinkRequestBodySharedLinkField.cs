...
namespace Box.Managers {
    public class UpdateWebLinkUpdateSharedLinkRequestBodySharedLinkField {
        /// <summary>
        ...
        public UpdateWebLinkUpdateSharedLinkRequestBodySharedLinkAccessField? Access { get; set; } = default;
        ...
        public UpdateWebLinkUpdateSharedLinkRequestBodySharedLinkPermissionsField? Permissions { get; set; } = default;

        public UpdateWebLinkUpdateSharedLinkRequestBodySharedLinkField() {
