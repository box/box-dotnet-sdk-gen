...
namespace Box.Managers {
    public class UpdateWebLinkAddSharedLinkRequestBodyArgSharedLinkField {
        ...
        public UpdateWebLinkAddSharedLinkRequestBodyArgSharedLinkFieldAccessField? Access { get; set; } = default;
        ...
        public UpdateWebLinkAddSharedLinkRequestBodyArgSharedLinkFieldPermissionsField? Permissions { get; set; } = default;

        public UpdateWebLinkAddSharedLinkRequestBodyArgSharedLinkField() {
