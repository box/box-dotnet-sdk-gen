...
namespace Box.Managers {
    public class UpdateWebLinkAddSharedLinkRequestBodySharedLinkField {
        /// <summary>
        ...
        public UpdateWebLinkAddSharedLinkRequestBodySharedLinkAccessField? Access { get; set; } = default;
        ...
        public UpdateWebLinkAddSharedLinkRequestBodySharedLinkPermissionsField? Permissions { get; set; } = default;

        public UpdateWebLinkAddSharedLinkRequestBodySharedLinkField() {
