...
namespace Box.Managers {
    public class UpdateWebLinkUpdateSharedLinkRequestBodySharedLinkPermissionsField {
        /// <summary>
        ...
        public UpdateWebLinkUpdateSharedLinkRequestBodySharedLinkPermissionsField() {
