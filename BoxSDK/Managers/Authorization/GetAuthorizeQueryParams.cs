...
namespace Box.Managers {
    public class GetAuthorizeQueryParams {
        ...
        /// </summary>
        public GetAuthorizeQueryParamsResponseTypeField ResponseType { get; set; }
        ...
        public GetAuthorizeQueryParams(GetAuthorizeQueryParamsResponseTypeField responseType, string clientId) {
