...
namespace Box.Managers {
    public class UpdateFileUpdateSharedLinkRequestBodyArgSharedLinkField {
        ...
        public UpdateFileUpdateSharedLinkRequestBodyArgSharedLinkFieldAccessField? Access { get; set; } = default;
        ...
        public UpdateFileUpdateSharedLinkRequestBodyArgSharedLinkFieldPermissionsField? Permissions { get; set; } = default;

        public UpdateFileUpdateSharedLinkRequestBodyArgSharedLinkField() {
