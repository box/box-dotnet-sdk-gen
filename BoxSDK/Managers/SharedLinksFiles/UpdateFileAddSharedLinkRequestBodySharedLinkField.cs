...
namespace Box.Managers {
    public class UpdateFileAddSharedLinkRequestBodySharedLinkField {
        /// <summary>
        ...
        public UpdateFileAddSharedLinkRequestBodySharedLinkAccessField? Access { get; set; } = default;
        ...
        public UpdateFileAddSharedLinkRequestBodySharedLinkPermissionsField? Permissions { get; set; } = default;

        public UpdateFileAddSharedLinkRequestBodySharedLinkField() {
