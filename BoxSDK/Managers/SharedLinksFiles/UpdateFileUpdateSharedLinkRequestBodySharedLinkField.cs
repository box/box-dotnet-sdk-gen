...
namespace Box.Managers {
    public class UpdateFileUpdateSharedLinkRequestBodySharedLinkField {
        /// <summary>
        ...
        public UpdateFileUpdateSharedLinkRequestBodySharedLinkAccessField? Access { get; set; } = default;
        ...
        public UpdateFileUpdateSharedLinkRequestBodySharedLinkPermissionsField? Permissions { get; set; } = default;

        public UpdateFileUpdateSharedLinkRequestBodySharedLinkField() {
