...
namespace Box.Sdk.Gen.Tests.Integration {
    ...
    public class WorkflowsManagerTests {
        ...
        public async System.Threading.Tasks.Task TestWorkflows() {
            ...
            Workflows workflows = await adminClient.Workflows.GetWorkflowsAsync(queryParams: new GetWorkflowsQueryParams(folderId: workflowFolderId)).ConfigureAwait(false);
