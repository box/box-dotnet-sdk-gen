...
namespace Box.Sdk.Gen.Tests.Integration {
    ...
    public class WebhooksManagerTests {
        ...
        public async System.Threading.Tasks.Task TestWebhooksCrud() {
            ...
            Webhook webhookFromApi = await client.Webhooks.GetWebhookByIdAsync(webhookId: NullableUtils.Unwrap(webhook.Id)).ConfigureAwait(false);
            ...
            Webhook updatedWebhook = await client.Webhooks.UpdateWebhookByIdAsync(webhookId: NullableUtils.Unwrap(webhook.Id), requestBody: new UpdateWebhookByIdRequestBody() { Address = "https://example.com/updated-webhook" }).ConfigureAwait(false);
            ...
            await Assert.That.IsExceptionAsync(async() => await client.Webhooks.DeleteWebhookByIdAsync(webhookId: NullableUtils.Unwrap(webhook.Id)).ConfigureAwait(false));
